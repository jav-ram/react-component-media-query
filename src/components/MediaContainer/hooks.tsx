import { ForwardedRef, RefObject, useCallback, useEffect, useRef, useState } from "react";
import { ContainerDimensions } from "../BatchMediaContainer/types";
import MediaContainerObserver from "../../Observer/MediaContainerObserver";

type useMediaContainerPropsType = { ref: ForwardedRef<HTMLElement> | RefObject<HTMLElement>, preload?: boolean }
export const useMediaContainer = ({ ref: initialRef, preload = true }: useMediaContainerPropsType) => {
...
type useMediaContainerNewObserverPropsType = { ref: ForwardedRef<HTMLElement> | RefObject<HTMLElement>, preload?: boolean }
/**
 ...
 */
export const useMediaContainerNewObserver = ({ ref: initialRef }: useMediaContainerNewObserverPropsType) => {
  const [dimension, setDimension] = useState<ContainerDimensions>({ width: 0, height: 0 });
  const containerRef = useRef<HTMLElement>(null);
  const observerRef = useRef<ResizeObserver>(null);
